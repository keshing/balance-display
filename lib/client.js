  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      const css = [
        ...
        '.dyn-balance-alert{position:fixed;right:16px;bottom:16px;z-index:10001;pointer-events:auto;max-width:320px;background:var(--dsw-alias-bg-overlay,#fff);border:1px solid var(--dsw-alias-border-l2,rgba(128,128,128,.35));border-radius:10px;padding:10px 26px 10px 12px;box-shadow:0 6px 20px rgba(0,0,0,.2);color:var(--dsw-alias-label-primary);font-size:13px;line-height:1.6;position:relative}',
